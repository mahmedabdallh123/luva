...
def get_supervisors():
    """قائمة المشرفين"""
    return ["مشرف 1", "مشرف 2", "مشرف 3", "مشرف 4"]

def get_bale_types():
    """أنواع البالات"""
    return [
        "فق", "آتاپ", "هموه دست", "استیابت تدویر", "ایم", "ایم انتفاق", 
        "هموه تنظیم", "انتفاق", "شرق الغزل", "تصمیمات مختلف", 
        "تصمیمات غیر مختلف", "کمک", "افغان خام", "نوع قطن خام"
    ]
